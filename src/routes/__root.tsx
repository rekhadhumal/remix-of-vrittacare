...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VRITTACARE" },
      { name: "description", content: "Student wellness insights grounded in your habits and saved assessment data." },
      { name: "author", content: "VRITTACARE" },
      { property: "og:title", content: "VRITTACARE" },
